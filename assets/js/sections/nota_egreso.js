...
$(document).ready(function() {
   ...
   $('#medicosBase').typeahead({
    ...
    $("#add_otro_residente").click (function(e) {
        ...
        if(cont >= 4){
          ...
          '</div>'+
          '<div class=col-sm-3 >'+
          '<input id="medico'+ cont +'" class=form-control type="text" required name="cedula_residente[]" placeholder="Matricula">'+
          '</div>'+
          '<div class=col-sm-2 >'+
   ...
   $('.Form-Nota-Egreso').submit(function (e) {
        e.preventDefault();
        SendAjax($(this).serialize(),'Sections/Documentos/AjaxNotaEgreso',function (response) {
