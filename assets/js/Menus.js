...
$(document).ready(function (){
    ...
    function mn1(accion,data){
        bootbox.confirm({    
            title: "<h5>AGREGAR MENU NIVEL 1</h5>",
            message: '<div class="">'+
                        '<div class="row" >'+
                            '<div class="col-md-6" >'+
                                '<div class="form-group">'+
                                    '<label class="mayus-bold">Nombre del Menu</label>'+
                                    '<input class="form-control" value="'+data.mn1_menu_1+'" id="mn1_menu_1">'+
                                '</div>'+
                                '<div class="form-group">'+
                                    '<label class="mayus-bold">Url</label>'+
                                    '<input class="form-control" value="'+data.mn1_url+'" id="mn1_url">'+
                                '</div>'+
                                '<div class="form-group">'+
                                    '<label class="mayus-bold">Status</label>'+
                                    '<select class="form-control" id="menuN1_status">'+
                            ...
                            '<div class="col-md-6">'+
                                '<div class="form-group">'+
                                    ...
                                    '<input class="form-control" value="'+data.mn1_icono+'" id="mn1_icono">'+
                                '</div>'+
                                '<div class="form-group">'+
                                    '<label class="mayus-bold">Nivel 2</label>'+
                                    '<select class="form-control" id="mn1_c_m">'+
                ...
                if(response==true){
                    if($('body #mn1_menu_1').val()!='' && $('body #mn1_url').val()!=''){
                        SendAjaxPost({
                            ...
                            accion          :accion,
                            csrf_token      :$.cookie('csrf_cookie')
                        },'Sections/Menu/insert_menuN1',function (response) {
    ...
    $('.btn-add-mn1-rol').click(function (){
        ...
        bootbox.dialog({    
            title: "<h5>AGREGAR ROL</h5>",
            message: '<div class="">'+
                        '<div class="row" >'+
                            '<div class="col-md-12" >'+
                                '<select class="width100 select2" id="tipo_usuarios_mn1">'+roles+'</select>'+
                            '</div>'+
            ...
            buttons: {
                success: {
                    ...
                    callback: function() {
                        $.ajax({
                            url: base_url+"Sections/Menu/insert_mn1_rol",
                            dataType: 'json',
                            type: 'POST',
                            data:{
                                'menuN1_id':id_mn1,
            ...
            buttons: {
                ...
                if(res==true){
                    if($('body #menuN2_menu').val()!='' && $('body #menuN2_url').val()!=''){
                        ...
                        },'Sections/Menu/insert_menuN2',function(response){
                            if(response.accion=='1'){
                                msj_success_noti('Registro guardado.');
                                location.reload();
                            }else{
