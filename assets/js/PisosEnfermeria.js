$(document).ready(function () {
    ...
    function AjaxCamas() {
        $.ajax({
            url: base_url+"Pisos/Enfermeria/AjaxCamas",
            dataType: 'json',
    ...
    $('body').on('click','.btn-paciente-agregar',function (){
        ...
        bootbox.prompt({
            title: "<h5>Ingresar No. de paciente</h5>",
            inputType: 'text',
            size:'small',
            callback: function (result) {
                if(result!=''){
                    ...
                    SendAjax(info,'Pisos/Enfermeria/AjaxObtenerPaciente',function (response) {
            ...
            AjaxBuscarEmpleado(function (response) {
                if(response.accion=='1'){
                    SendAjax({
                        ...
                        csrf_token:csrf_token
                    },"Pisos/Enfermeria/AjaxIngresoPacientePisos",function (response) {
                        AjaxCamas();
                    },"Ingresando paciente a pisos...")                    
                }
            },empleado_matricula)
        }else{
    ...
    $('body').on('click','.btn-paciente-agregar-ah',function (e) {
        ...
        if(triage_id!=null && triage_id!=''){
            $.ajax({
                url: base_url+"Pisos/Enfermeria/AjaxCheckAsignacionCama",
                type: 'POST',
                dataType: 'json',
                data:{
