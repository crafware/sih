                        ...
                        bootbox.confirm({
                            ...
                            message: '<div class="row">'+
                                        ...
                                        '<div class="col-md-12">'+
                                            ...
                                            //'<h3 style="line-height: 1.4;margin-top:-10px"><b>MÉDICO: </b> '+(data.medico.empleado_nombre==null ? 'S/E': data.medico.empleado_nombre)+' '+(data.medico.empleado_apellidos==null ? 'S/E': data.medico.empleado_apellidos)+'</h3>'+
                                            '<h3 style="line-height: 1.4;margin-top:-10px"><b>CAMA: </b> '+(data.obs.observacion_cama_nombre==null ? 'NO ASIGNADO' : data.obs.observacion_cama_nombre )+'</h3>'+
                                            '<h3 style="line-height: 1.4;margin-top:-10px"><b>INGRESO: </b> '+data.obs.observacion_mfa+' '+data.obs.observacion_mha+'</h3>'+
                                        '</div>'+
                                    '</div>',
                            buttons:{
                                confirm:{
            ...
            $.ajax({
                ...
                data: {
                    ...
                    if(data.accion=='1'){
                        ...
                        msj_error_noti('EL N° DE PACIENTE NO CORRESPONDE A ESTA ÁREA_____')
                    }if(data.accion=='4'){ 
                        bootbox.confirm({
                            title:'<h5>AGREGAR PACIENTE</h5>',
            ...
            bootbox.dialog({
                ...
                message:'<div class="row ">'+
                            '<div class="col-sm-12">'+
                                ...
                                '<input type="radio" name="observacion_alta_value" value="Alta e ingreso a hospitalización" id="hospitalizacion"><label for="hospitalizacion">Alta e ingreso a hospitalización</label><br> '+
                                '<input type="radio" name="observacion_alta_value" value="Alta e ingreso a UCI" id="uic"><label for="uic">Alta e ingreso a UCI</label><br> '+
                                '<input type="radio" name="observacion_alta_value" value="Alta e ingreso a Choque" id="choque"><label for="choque">Alta e ingreso a Hemodiálisis</label><br>'+
                                '<input type="radio" name="observacion_alta_value" value="Alta a HGZ" id="Desconocido"><label for="Desconocido">Alta a HGZ</label><br>'+
                                '<input type="radio" name="observacion_alta_value" value="Defunción" id="Defuncion"><label for="Defuncion">Defunción</label>'+
                            '</div>'+
                        '</div>',
                size:'small',
                buttons: {
