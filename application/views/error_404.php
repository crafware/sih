        ...
        <div class="app">
            <div class="amber-200 bg-big">
                <div class="text-center">
                    ...
                    <h2 class="h1 m-v-lg text-black"><i class="fa fa-frown-o fa-4x"></i></h2>
                    <p class="h4 m-v-lg text-u-c font-bold text-black">Disculpe! La página que está buscando no existe.</p>
                    <div class="p-v-lg">
                        <a href="<?= base_url()?>inicio" md-ink-ripple class="md-btn indigo md-raised p-h-lg">
