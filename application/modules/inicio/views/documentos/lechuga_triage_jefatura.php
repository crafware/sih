...
<page backleft="0mm" backright="0mm" backtop="91.5mm">
    <page_header>
       <div style="position: absolute">
            ...
            <div style="position: absolute;margin-left: 430px;margin-top: 81px;font-size: 11px;width: 45px;text-align: center">
                <?php 
            ...
            <div style="font-size: 6px;position: absolute;margin-left: <?php
                  ...
                  if(strpos($_GET['area_ac'], 'Cons') !== false){
                     echo  '571px';
                    }if(strpos($_GET['area_ac'], 'riage') !== false){
                ...
                <?php
                  ...
                  if(strpos($_GET['area_ac'], 'Cons-Obs') !== false){
                     echo  'Consul/Obs';
                    }if(strpos($_GET['area_ac'], 'riage') !== false){
                        echo 'X';
                    }
