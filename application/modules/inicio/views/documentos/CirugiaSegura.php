...
<page backtop="20mm">
    <page_header>
        <img src="<?=  base_url()?>assets/doc/observacion/CIRUGIA_SEGURA.png" style="position: absolute;width: 100%;margin-top:20px;margin-left: -5px;">
        <style>
    ...
    <div style="position: absolute;top: 0px">
        <div style="position: absolute;top: -40px;left: 130px;font-size: 11px;width: 240px;padding-top: 5px">UMAE | Dr. Victorio de la Fuente Narváez</div>
