...
<page backleft="10mm" backright="10mm" backtop="7mm">
    ...
    <div style="position: absolute;">
        <img src="<?=  base_url()?>assets/doc/lechuga/4_30_6BUENA_1.png" style="position: absolute;width: 100%;">
        ...
        <div style="position: absolute;margin-left: 280px;margin-top: 120px;font-size: 11px;"><?=$medico['empleado_nombre']?> <?=$medico['empleado_apellidos']?></div>
