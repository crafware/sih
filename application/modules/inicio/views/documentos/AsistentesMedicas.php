...
<page backtop="20mm" backbottom="7mm" backleft="10mm" backright="10mm">
    <page_header>
        <div style="margin-top: 20px;margin-left: 30px;margin-right: 40px">
            <table>
                <tr>
                    <td style="width: 60%;text-align: left"><b>ASISTENTE MÉDICA :</b> <?=$Am['empleado_nombre']?> <?=$Am['empleados_apellidos']?></td>
        ...
        <table style="width: 100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-transform: uppercase;font-size: 9px;"><?=$value['empleado_nombre']?> <?=$value['empleado_apellidos']?></td>
