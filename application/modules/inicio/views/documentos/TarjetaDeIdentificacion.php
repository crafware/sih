...
<page backtop="85mm" backbottom="7mm" backleft="10mm" backright="10mm">
    <page_header>
        <img src="<?=  base_url()?>assets/doc/TARJETA_DE_IDENTIFICACION.png" style="position: absolute;width: 100%;margin-top: 0px;margin-left: -5px;">
        <div style="position: absolute;margin-top: 15px">
            ...
            <div style="position: absolute;top: 35px;left: 625px;font-size: 18px;width: 90px;padding: 2px;text-align: center"><b><?=$obs['observacion_cama_nombre']?></b></div>
            <div style="position: absolute;top: 146px;left: 104px;font-size: 12px;text-transform: uppercase"><b><?=$area['area_nombre']?></b></div>
            <div style="position: absolute;top: 146px;left: 564px;font-size: 12px;text-transform: uppercase"><b><?=$obs['observacion_fac']?> <?=$obs['observacion_hac']?></b></div>
            <div style="position: absolute;top: 164px;left: 104px;font-size: 20px;text-transform: uppercase"><b><?=$PINFO['pum_nss']?> <?=$PINFO['pum_nss_agregado']?></b></div>
            ...
            <div style="position: absolute;top: 287px;left: 40px;font-size: 10px;text-transform: uppercase;width: 480px;">
                <?=$hojafrontal['hf_diagnosticos_lechaga']?>
            </div>
            ...
            <img src="<?= base_url()?>assets/doc/Captura.png" style="position: absolute;top: 270px;left: 630px;width: 60px">
        </div>
