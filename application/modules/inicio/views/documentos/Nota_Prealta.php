    <form class="Form-Nota-Egreso">
          ...
          <div class="form-group">
            <div class="input-group m-b">
              <?php
                ...
                }else if($_GET['TipoNota']=='Nota de Prealta'){
                  $tipo_nota = 'Nota de Pre-alta';
                }
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label class="md-check">
                <input type="radio" name="motivo_egreso" data-value="<?=$NotaPreAlta['motivo_egreso']?>" value="1" required><i class="blue"></i><span class="label-text">Alta Médica</span>
              </label>
            </div>
            <div class="form-group">
              <label class="md-check">
                <input type="radio" name="motivo_egreso" data-value="<?=$NotaPreAlta['motivo_egreso']?>" value="2"><i class="blue"></i><span class="label-text">Alta Voluntaria</span>
              </label>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              <label class="md-check">
                <input type="radio" name="motivo_egreso" data-value="<?=$NotaPreAlta['motivo_egreso']?>" value="3"><i class="blue"></i><span class="label-text">Alta por Mejoria</span>
              </label>
            </div>
            <div class="form-group">
              <label class="md-check">
                <input type="radio" name="motivo_egreso" data-value="<?=$NotaPreAlta['motivo_egreso']?>" value="4"><i class="blue"></i><span class="label-text">Alta por Máximo Beneficio</span>
              </label>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              <label class="md-check">
                <input type="radio" name="motivo_egreso" data-value="<?=$NotaPreAlta['motivo_egreso']?>" value="6"><i class="blue"></i><span class="label-text">Alta por Defunción</span>
              </label>
            </div>
            <div class="form-group">
              <label class="md-check">
                <input type="radio" name="motivo_egreso" data-value="<?=$NotaPreAlta['motivo_egreso']?>" value="7"><i class="blue"></i><span class="label-text">Alta por Fuga o Abandono</span>
              </label>
            </div>
          </div>
          <div class="col-md-5">
            <div class="form-group">
              <label class="md-check">
                <input type="radio" name="motivo_egreso"  data-value="<?=$NotaPreAlta['motivo_egreso']?>" value="5"><i class="blue"></i><span class="label-text">Alta por Transferencia a Otro Centro Hospitalario</span>
              </label>
            </div>
          </div>
        </div>
          ...
          <div class="panel-body">
            <div class="col-md-12">
              <div class="form-group" id = 'area_editor_div1'>
                  <textarea onchange="deleteTypeLetter('area_editor_div1');" class="form-control editor" name="resumen_clinico" id="area_editor1" placeholder="Anote el Resumen Clínico y Evolución del Paciente"><?=$NotaPreAlta['resumen_clinico']?></textarea>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="panel-body">
          <div class="col-md-12">
            <div class="form-group" id = 'area_editor_div2'>
              <textarea onchange="deleteTypeLetter('area_editor_div2');" class="form-control editor" name="exploracion_fisica" id="area_editor2" placeholder="Anote el estado fisico del paciente,, neurologico, respiratorios, cardiaco, gastrometabolico, genitourinario entre otros"><?=$NotaPreAlta['exploracion_fisica']?></textarea>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="panel-body">
          <div class="col-md-12">
            <div class="form-group" id = 'area_editor_div3'>
              <textarea onchange="deleteTypeLetter('area_editor_div3');" class="form-control editor" name="laboratorios" id="area_editor3" placeholder="Anote los resultados de Laboratorio y resultados de Examenes Clínicos"><?=$NotaPreAlta['laboratorios']?></textarea>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="panel-body">
          <div class="col-md-12">
            <div class="form-group" id = 'area_editor_div4'>
              <textarea onchange="deleteTypeLetter('area_editor_div4');" class="form-control editor" name="gabinetes" id="area_editor4" placeholder="Anote los resultados de Rayos X y Gabinete"><?=$NotaPreAlta['gabinetes']?></textarea>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="panel panel-default panel-y">
        ...
        <div class="panel-body">
          <div class="col-md-12">
            <div class="form-group">        
              <textarea class="form-control" name="pronostico" rows="2" placeholder="Anote"><?=$NotaPreAlta['pronostico']?></textarea>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="panel-body">
          <div class="col-md-12">
            <div class="form-group" id = 'area_editor_div1_2'>
              <textarea onchange="deleteTypeLetter('area_editor_div1_2');" class="form-control editor" name="plan" id="area_editor2" placeholder="Anote plan de salud"><?=$NotaPreAlta['plan']?></textarea>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-12">
            <div class="col-md-3">
              <div class="form-group" style="padding-top: 10px;">        
                <?php
                  if($NotaPreAlta['req_oxigeno']==Null){
                    $checkEstado = "";
                    $valor_check = "0";
                  }else {
                    $checkEstado = "checked";
            ...
            <div class="col-md-3">    
              <?php
                  ...
                  if(($NotaPreAlta['req_ambulancia'])==NUll){
                    $checkEstado2 = "";
            ...
            <div class="col-md-4"> 
              <div class="form-group div_ambulancia hidden" style="padding-top: 10px">                     
                  ...
                  <label class="md-check">
                    <input type="radio" name="req_ambulancia"  data-value="<?=$NotaPreAlta['req_ambulancia']?>" value="2"><i class="green"></i>
                  </label>
                  <span class="label-text">Sin oxigeno</span>
                  <label class="md-check">
                    <input type="radio" name="req_ambulancia"  data-value="<?=$NotaPreAlta['req_ambulancia']?>" value="3"><i class="green"></i>
                  </label>
              </div>
            </div>
          </div>
      ...
      <div class="panel panel-default panel-y">
        ...
        <div class="panel-body">
          ...
          <?php }?>
          <div class="col-md-12">
            <?php if($_GET['a']=='add' || $NotaPreAlta['prealta']!='0' && $NotaPreAlta['proceso']!='1'){?>
                <div class="col-md-2" id="prealta">
                  <div class="form-group">
                    <label class="md-check">
                      <input type="radio" name="proceso" data-value="<?=$NotaPreAlta['proceso']?>" value="1" required><i class="blue"></i><span class="label-text">Pre-alta</span>
                    </label>
                  </div>
                </div>
            <?php }?> 
            <?php if($_GET['a']=='add' || $NotaPreAlta['alta']=='1' || $NotaPreAlta['alta']=='0'){?>
                <div class="col-md-2" id="alta">
                  <div class="form-group">
                    <label class="md-check">
                      <input type="radio" name="proceso" data-value="<?=$NotaPreAlta['proceso']?>" value="2" required><i class="blue"></i><span class="label-text">Alta</span>
                    </label>
                  </div>
                </div>
            <?php }?> 
            <?php if($_GET['a']=='edit' ){?>
                <div class="col-md-2" id="altacancelada">
                  <div class="form-group">
                    <label class="md-check">
                      <input type="radio" name="proceso" data-value="<?=$NotaPreAlta['proceso']?>" value="3"><i class="blue"></i><span class="label-text">Cancelar Alta</span>
                    </label>
                  </div>
                </div>
            <?php }?>
            ...
            <div class="col-md-4" id="informeFamiliar">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="recibe_informe" value="<?=$NotaPreAlta['recibe_informe']?>">
              </div>
            </div>
          </div>
          <div class="col-md-12">
            <div class="form-group" id = 'area_editor_div1_3'>         
              <textarea onchange="deleteTypeLetter('area_editor_div1_3');" class="form-control editor" name="comentarios" id="area_editor3" placeholder="Comentarios"><?=$NotaPreAlta['comentarios']?></textarea>
            </div>
          </div>
        </div>
      </div>    
      ...
      <div class="panel panel-default panel-y">
        <div class="panel-heading"><h4>Información de médico tratante</h4></div>
        <div class="panel-body">
          <div class="col-md-12">
            <?php 
                ...
                <div class="form-group">
                  <div class="col-sm-8 col-ms-8">
                    <label>Nombre de supervisor Médico de Base</label>
                      <select class="select2 width100" name="medicoBase" id="medicoBase" placeholder="Teclee el nombre del medico tratante" data-value="<?=$Nota['notas_medicotratante']?>" required>
              ...
              <div class="col-md-12">  
                <div class="form-group">
                  <div class="col-md-12" style="padding: 15px 0px 15px 15px">
                    <label for="">Información de médico(s) residente(s)</label>
                  </div>
