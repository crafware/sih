<?php ob_start(); ?>
<page backtop="78.5mm" backbottom="50mm" backleft="48" backright="5mm">
    <page_header>
    ...
    <span style="text-align: justify">
        <?php if($Nota['nota_motivoInterconsulta']!=''){?>
            <h5 style="margin-bottom: -6px">MOTIVO DE INTERCONSULTA</h5>
            <?=$Nota['nota_motivoInterconsulta']?><br>
        <?php }?>
        ...
        <?php }?>
        <?php if($Nota['nota_estadosalud']!=''){?>
            CUIDADOS DE ENFEREMERIA: <?=$Nota['nota_cuidadosenfermeria']?><br>
        <?php }?>
