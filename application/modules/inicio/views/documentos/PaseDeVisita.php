...
<page  >
    <div style="position: relative;margin: 5px">
        <div style="position: absolute;left: 0px;top: 5px">
            <img src="<?= base_url()?>assets/img/imss2.png" style="width: 30px;">
        </div>
        <div style="position: absolute;left: 30px;font-size: 10px;top: 5px;width: 200px;">
            <h5 style="font-size: 8.5px;margin-top: 0px">UMAE | DR. VICTORIO DE LA FUENTE NARVÁEZ</h5>
            <h5 style="font-size: 8px;margin-top: -14px;">HOSPITAL DE TRAUMATOLOGÍA</h5>
            <h5 style="font-size: 8px;margin-top: -14px;">COORDINACIÓN DE ASISTENTES MÉDICAS</h5>
        </div>
        <div style="position: absolute;left: 0px;top: 50px;width: 218px;text-transform: uppercase">
            ...
            <h4 style="font-size: 10px;padding: 0px;margin-top: -12px"><b>ELABORO:</b> 
                ...
                echo $sqlEmpleado['empleado_nombre'].' '.$sqlEmpleado['empleado_apellidos'];
                ?>
                </span>
            </h4>
