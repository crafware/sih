  ...
  <page_header>
      ...
      <div style="position: absolute;margin-top: 15px">
        ...
        <div style="font-size: 10px; position: absolute;margin-top: 238px; margin-left: 13px ">
            ...
            <div style="position: absolute;margin-left: 15px;margin-top: 300px;width: 130px;font-size: 12px;text-align: center">
              ...
              <h5 style="margin-top: 1px">Talla:</h5><p style="margin-top: -28px;margin-left: 80"><?=$SignosVitales['sv_talla']?> m</p>
              <?php }?>
              <?php if($SignosVitales['sv_ta']!=''){?>
              <h5 style="margin-top: 5">Presión Arterial</h5><p style="margin-top: -15px"><?=$SignosVitales['sv_ta']?> mmHg</p>
              <?php }?>
              ...
              <h5 style="margin-top: -1">Estado de salud</h5><p style="margin-top: -14px"><?=$Nota['nota_estadosalud']?></p>
              <?php }?>
            </div>
    ...
    <!--<div style="position:absolute; left: -10px; margin-top: -17px; font-size: 12px;">-->
      ...
      <?php if($_GET['indicaciones'] == 1){ ?>
        ...
        <?php }
            else { ?> <!-- Informacion general de la nota evolucion -->
