...
<page backtop="85mm" backbottom="7mm" backleft="10mm" backright="10mm">
    <page_header>
        <img src="<?=  base_url()?>assets/doc/TI_PISOS.png" style="position: absolute;width: 100%;margin-top: 46px;margin-left: -5px;">
        <div style="position: absolute;margin-top: 60px">
            ...
            <div style="position: relative;margin-top: 200px;margin-left: 34px">
                ...
                <img src="<?= base_url()?>assets/doc/Triangulo.png" style="position: absolute;top: 140px;left: 570px;width: 120px">
