                    ...
                    <div class="panel-body b-b b-light">
                        <form class="PaseDeVisitaFamiliar">
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="familiar_nombre_ap" value="<?=$info['familiar_nombre_ap']?>" required="" placeholder="Apellido Paterno">
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="familiar_nombre_am" value="<?=$info['familiar_nombre_am']?>" required="" placeholder="Apellido Materno">
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <div class="form-group">
