                            ...
                            <div class="panel-body b-b b-light">
                                <div class="card-body" style="padding-bottom: 0px">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <!--  <div class="form-group">
                                                <label style="text-transform: uppercase;font-weight: bold">Médico que recibió</label>
                                                <input class="form-control" name="asistentesmedicas_mt" value="<?=$solicitud['asistentesmedicas_mt']?>"> 
                                            </div>  -->
                                            <div class="form-group">
