                    ...
                    <form class="regitro-am-tr">
                        <div class="panel-body b-b b-light">
                            <div class="card-body">
                                ...
                                <div class="row" id="datosAfiliacion">
                                    <div class="col-md-4">
                                ...
                                <div class="row hide" id="nssConformado">
                                   <div class="col-md-4">
                                        <label style="font-weight: bold">N.S.S CONFORMADO</label>
                                        <div class="input-group m-b">
                                            <span class="input-group-addon pointer blue generarNss">
                                                 <i class="fa fa-cog blue" style="font-weight: bold"> Generar</i>
                                            </span>
                                            <input type="text" name="pum_nss_armado" class="form-control" value="<?=$PINFO['pum_nss_armado']?>" readonly>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="ingreso_medico" id="divMedicos" class="form-control" data-value="<?=$Doc43051['ingreso_medico']?>" required>
                                                        ...
                                                        <option value="<?=$Doc43051['ingreso_medico']?>"><?=$medicoTratante['empleado_apellidos']?> <?=$medicoTratante['empleado_nombre']?>
                                                        </option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="diagnostico_presuntivo"  value="<?=$Doc43051['diagnostico_presuntivo']?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="cama" id="cama" data-value="<?=$Doc43051['cama_id']?>" data-area="<?=$Doc43051['area_id']?>" class="form-control" required>
                                                    <!-- Se llena las opciones de manera dinamica desde ajax y controlador -->
