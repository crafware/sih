                ...
                <div class="panel-body b-b b-light">
                    <div class="card-body">
                        <div class="row" style="margin-top: -10px">
                            <form class="form-reportes" method="GET" action="<?= base_url()?>Arimac/Reportes/ReporteGeneral">
                                <div class="col-md-4 " >
                                    <div class="input-group m-b">
                                        <span class="input-group-addon back-imss" style="border:1px solid #256659">
                                            <i class="fa fa-calendar"></i>
                                        </span>
                                        <input type="text" name="inputFechaInicio" required="" class="form-control dp-yyyy-mm-dd" autocomplete="off" placeholder="Fecha de Inicio">
                                    </div>
                                </div>
                                <div class="col-md-4 " >
                                    <div class="input-group m-b">
                                        ...
                                        <input type="text" name="inputFechaTermino" required="" class="form-control dp-yyyy-mm-dd" autocomplete="off" placeholder="Fecha de Termino">
                                    </div>
                                </div>
                                <div class="col-md-4">
