                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="scrollable-dropdown-menu" id="prefetch">
                                            <input name="ci_diagnostico" id="dxPreop" value="<?=$si[0]['ci_nombre_diagnostico']?>" class="form-control typeahead" autocomplete="off">
                                        </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#prefetch .typeahead').typeahead({minLength: 3}, {
            ...
            templates:
             {
              suggestion:Handlebars.compile('<div class="row"><div class="col-md-10" style="padding-right:5px; padding-left:5px;">{{nombre}}</div></div>')
             }
        });
        let cirugias = new Bloodhound({
            ...
            $('#prefetch2 .typeahead').typeahead({minLength: 3}, {
                ...
                templates:
                {
                suggestion:Handlebars.compile('<div class="row"><div class="col-md-10" style="padding-right:5px; padding-left:5px;">{{cirugia}}</div></div>')
                }
            });
    });
</script>
