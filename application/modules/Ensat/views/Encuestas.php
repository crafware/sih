        ...
        <div class="box-inner col-md-10 col-centered" style="margin-top: 10px">
            <div class="panel panel-default ">
                <div class="panel-heading p teal-900 back-imss">
                    ...
                    <a href="#" md-ink-ripple="" class="md-btn md-fab m-b red waves-effect pull-right ensat-enc-add-edit" data-id="0" data-nombre="" data-estado="false" data-accion="add">
                                ...
                                <tbody>
                                    ...
                                    <tr id="<?=$value['encuesta_id']?>">
                                        ...
                                        <td class="text-center">
                                            <a href="<?=  base_url()?>Ensat/EncuestaPreguntas?enc=<?=$value['encuesta_id']?>">
                                                <i class="fa fa-list tip icono-accion" data-original-title="Agregar Preguntas"></i>
                                            </a>&nbsp;
                                            <i class="fa fa-pencil icono-accion pointer ensat-enc-add-edit" data-id="<?=$value['encuesta_id']?>" data-nombre="<?=$value['encuesta_nombre']?>" data-estado="<?=$value['encuesta_estado']?>" data-accion="edit"></i>&nbsp;
