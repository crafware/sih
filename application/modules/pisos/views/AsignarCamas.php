            ...
            <div class="col-md-12 col-centered">
                <div class="panel panel-default">
                    <div class="panel-heading p teal-900 back-imss">
                        <span style="font-size: 15px;font-weight: 500;text-transform: uppercase"><b>ASIGNACIÓN DE CAMAS:</b> <?=$Piso[0]['piso_nombre']?> <i class="fa fa-arrow-right"></i> <?=$Sala[0]['sala_nombre']?> </span>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="sala_id" value="<?=$this->uri->segment(3)?>">
                                    <input type="hidden" name="piso_id" value="<?=$_GET['piso_id']?>">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
