                        ...
                        <table class="table table-bordered table-hover footable"  data-filter="#filter" data-page-size="15">
                            ...
                            <?php foreach ($Gestion as $value) {?>
                                <tr id="<?=$value['piso_id']?>" >
                                    ...
                                    <td>
                                        <?= Modules::run('Pisos/TotaSalas',array('piso_id'=>$value['piso_id']))?> Salas
                                    </td>
                                    <td class="text-center ">
                                        <a href="<?=  base_url()?>Pisos/Salas/<?=$value['piso_id']?>" target="_blank">
                                            <i class="fa fa-trello icono-accion tip" data-original-title="Salas"></i>
                                        </a>&nbsp;
