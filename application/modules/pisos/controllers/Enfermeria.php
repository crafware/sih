    ...
    public function AjaxCamas() {
        ...
        if(!empty($Camas)){
            foreach ($Camas as $value) {
                ...
                if($value['cama_status']=='Disponible'){
                    ...
                    */
                ...
                }else if($value['cama_status']=='En Limpieza'){ // Cama sucia
                    $CamaStatus='grey-900';
                    $area=$value['cama_status'];
                    /*
                    $Accion='<ul class="list-inline">
                ...
                }else if($value['cama_status']=='Ocupado'){  // Cama - Ocupada
                    if($value['cama_genero']=='HOMBRE') {  // Ocupado-Azul Mujer
                        $CamaStatus='blue-800';
                    }else if($value['cama_genero']=='MUJER'){ // Ocupado-Rosa Mujer
                        $CamaStatus='pink-500';
                    }
                    ...
                    $Lista.='<li><a class="cambiar-cama-paciente" data-id="'.$sqlTriage[0]['triage_id'].'" data-area="'.$sqlTriage[0]['ap_area'].'" data-cama="'.$value['cama_id'].'"><i class="fa fa-bed icono-accion"></i> Cambiar Cama</a></li>';
                ...
                }else if ($value['cama_status']=='Limpia') {
                    $CamaStatus='cyan-400';
                ...
                if($value['cama_fh_estatus']!=''){
                    ...
                    $TT_=$TT->format('%a Dias') .$TT->h.' Hrs '.$TT->i.' Min ';
                }else{
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="margin-left: -10px;margin-top:-9px">
                                                <small style="opacity: 1;font-size: 10px"> 
                                                    ...
                                                    <b class="text-right pull-right">jjj '.$sqlTriage[0]['ap_f_ingreso'].' '.$sqlTriage[0]['ap_h_ingreso'].'</b>
                                                </small>
                                            </div>
                                        </div>
                                    </div>
