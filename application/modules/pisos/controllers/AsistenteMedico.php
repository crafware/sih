...
class AsistenteMedico extends Config{
    ...
    public function index() {
        $this->load->view('AsistenteMedico');
    }
    ...
    public function AjaxCamas() {
        ...
        if(!empty($Camas)){
            foreach ($Camas as $value) {
                ...
                $DatosPaciente='<br><b>FOLIO DEL PACIENTE:</b> '.$info43051['triage_id'].'
                                    <table class="pull-left col-md-12">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="active">'.$NombrePaciente.'</td> 
                                                <td class="active">'.$NSS.'</td>
                                            </tr>
                                            <tr>
                                                <td><strong>SERVICIO TRATANTE</strong></td>
                                                <td><strong>MÉDICO TRATANTE</strong></td>
                                            </tr>
                                            <tr>
                                                <td>'.$Servicio['especialidad_nombre'].'</td>
                                                <td>'.$Medico['empleado_nombre'].' '.$Medico['empleado_apellidos'].'</td>
                                            </tr>
                                            <tr>
                                                <td><strong>FECHA DE REGISTRO</strong></td>
                                                <td><strong>FECHA Y HORA DE ASIGNACION DE CAMA</strong></td>
                                            </tr>
                                            <tr>
                                                <td>'.$fechaRegistro.'</td>
                                                <td>'.$info43051['ac_fecha_asignacion'].'</td>
                                            </tr>
                                            <tr>
                                                <td><strong>HOSPITALIZACION</strong></td>
                                                <td><strong>NOMBRE QUIEN ASIGNO CAMA</strong></td>
                                            </tr>
                                            <tr>
                                                <td>'.$info43051['tipo_ingreso'].'</td>
                                                <td>'.$asignaNombre.'</td>
                                            </tr>
                                            <tr>
                                                <td><strong>INGRESO</strong></td>
                                                <td><strong>DIAGNOSTICO DE INGRESO</strong></td>
                                            </tr>
                                            <tr>
                                                <td>'.$info43051['ac_internamiento'].'</td>
                                                <td>'.$info43051['ac_diagnostico'].'</td>
                                            </tr>
                                        </tbody>
                                    </table><br><hr>';
                $Accion1='<p>Seleccione una acción:</p>
                        <div class="col-md-12">
                        <div class="col-md-4" style="position: absolute;left: -15px">'.$CambiarCama.'</div>
                        <div class="col-md-4" style="position: absolute;left: 115px">'.$Imprimir43051.'</div>
                        <div class="col-md-4" style="position: absolute;left: 240px">'.$LiberarCama.'</div>
                        <div class="col-md-4" style="position: absolute;left: 357px">'.$AsignarCamaP.'</div>
                        </div>';
                $Accion2='<p>Seleccione una acción:</p><hr>
                        <div class="col-md-3">'.$CambiarCama.'</div>
                        <div class="col-md-3">'.$Imprimir43051.'</div>
                        <div class="col-md-3">'.$AltaPaciente.'</div>';
                ...
                }else if($value['cama_status']=='En Limpieza'){ // Sucia Color Ngro
                    $CamaStatus='grey-900';
                    $area=$value['cama_status'];
                    $Modal=$SinModal;
                    $Estado='Sucia';
                ...
                $col_md_3.='<div class="col-md-1 cols-camas" style="padding: 3px;margin-top:-20px">
                                <div class="card '.$CamaStatus.' color-white" style="border-radius:3px">
                                    <div class="card-heading" style="margin-top:0px;padding-bottom: 0px!important;">
                                        <h5 class="font-thin color-white" style="font-size:14px!important;margin-left: -15px;margin-top: -10px">
                                            <i class="fa fa-bed btn" '.$Modal.'></i><b>'.$value['cama_nombre'].'</b>          
                                        </h5>
                                    </div>
                                    <!--
                                    <div class="row">
                                    ...
                                    <div class="col-md-8" style="margin-left: 12px;margin-top:-1px">
                                        <small style="opacity: 1;font-size: 10px"><b class="text-left">'.$area.'</b</small>
                                    </div>
