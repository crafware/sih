                ...
                <div class="panel panel-default " style="margin-top: -20px">
                    ...
                    <div class="panel-heading p teal-900 back-imss">
                        <span style="font-size: 15px;font-weight: 500;text-transform: uppercase">
                            ...
                            <div class="row">
                                <div class="col-md-11">
                                    <b>Capturar datos del Paciente con problemas respiratorios</b>&nbsp;
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 ">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label style="text-transform: uppercase;font-weight: bold">Contacto responsable</label>
                                                    <input class="form-control" required name="pic_responsable_nombre" value="<?=$PINFO['pic_responsable_nombre']?>" placeholder="Persona responsable">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group" >
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                  <label style="text-transform: uppercase;font-weight: bold">Teléfono de contacto</label>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-4">
                                              <div class="form-group">
                                                  <label style="text-transform: uppercase;font-weight: bold">Municipio / Delegación</label>
