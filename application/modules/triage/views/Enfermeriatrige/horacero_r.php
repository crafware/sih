        ...
        <div class="box-inner col-md-12 col-centered">
            <div class="panel panel-default " style="margin-top: 10px">
                <div class="panel-heading p teal-900 back-imss">
                    <span style="font-size: 15px;font-weight: 500;text-transform: uppercase; color:#00FF00">Procedimiento para la clasificación de pacientes con problemas respiratorios</span>
