    ...
    <div class="box-cell">
        <div class="box-inner padding col-md-12 col-centered"> 
            <ol class="breadcrumb">
                ...
                <li><a style="text-transform: uppercase" href="<?= base_url()?>Abasto/Catalogos/Elementos?elemento=<?= $_GET['elemento']?>catalogo=<?=$_GET['catalogo']?>&sistema=<?=$_GET['sistema']?>"><?= substr($elemento['elemento_titulo'], 0,15)?>...</a></li>
                <li><a style="text-transform: uppercase" href="<?= base_url()?>Abasto/Catalogos/Rangos?name=<?= $_GET['name']?>&catalogo=<?=$_GET['catalogo']?>&sistema=<?=$_GET['sistema']?>&rango_id=<?= $_GET['rango_id']?>&elemento=<?= $_GET['elemento']?>">RANGOS</a></li>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12"><br>
                                <table class="table table-hover table-bordered footable" data-page-size="10" data-filter="#buscar" style="font-size: 13px">
                                    <thead>
                                        <tr>
                                            <th>CÓDIGO</th>
                                            <th>RANGO</th>
