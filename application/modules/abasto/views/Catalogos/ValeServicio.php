        ...
        <div class="col-md-10 col-centered">
            <div class="box-inner padding">
                <div class="panel panel-default ">
                        ...
                        <div class="row"><br>
                            <div class="col-md-12">
                                <div class="input-group m-b">
                                    ...
                                    <input type="text" class="form-control" required="" name="triage_id" placeholder="Ingresar N° de Paciente">
                                </div>
                            </div>
                        </div>
                       ...
                       <div class="row" style="padding: 14px;margin-top: 5px;">
                        ...
                        <div class="row"><br>
                            <div class="col-md-12">
                                <div class="input-group m-b">
                                    <span class="input-group-addon back-imss "><i class="fa fa-search"></i></span>
                                    <input type="text" required="" class="form-control" name="medico_matricula" placeholder="Matricula del Médico">
                                </div>
                            </div>
                        </div>
                        <?php } ?>
                        <?php if(isset($_GET['matricula_medica'])) {?>
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                        ...
                        <?php if(isset($_GET['procedimiento_codigo'])) {?>
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                        ...
                        <div class="row"><br>
                            <div class="col-md-12">
                                <div class="input-group m-b">
                                    <span class="input-group-addon back-imss "><i class="fa fa-search"></i></span>
                                    <input type="text" required="" class="form-control" name="servicio" placeholder="Buscar Solicitud">
                                </div>
                            </div>
                        </div>
                        ...
                        <form class="guardar-vale-servicio">
                            ...
                            <div class="row"><br><br>
                                <div class="col-md-6 col-md-offset-6">
                                    ...
                                    <?php if (isset($_GET['matricula_medica'])) { ?>
                                    <input name="matricula_medica" type="hidden" value="<?= $_GET['matricula_medica']?>">
                                    <?php } ?>
                                    <?php if (isset($_GET['paciente'])) { ?>
                    ...
                    <input id="matricula_medica" type="hidden" value="<?= $_GET['matricula_medica']?>">
                </div>
            </div>
        </div>
    </div>
