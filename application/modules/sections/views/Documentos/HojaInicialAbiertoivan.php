                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                      <div class="form-group">
                                       <h4><span class = "label back-imss border-back-imss">MOTIVO DE CONSULTA</span></h4>                      
...
<!-- FUNCIONALIDAD BARTHEL--><div class="col-md-12">
                                <label><b>FUNCIONALIDAD BARTHEL </b></label>
                                <div class="input-group">
                                 <input  type="text" size="25" class="form-control" data-toggle="modal" data-target='#barthel' placeholder="Clic para colocar valor" name="funcionalidad_barthel" id="puntos_barthel" value='' required autocomplete="off">
                                </div>
                             </div>  
                        ...
                        <div class="form-group">
                          <h4><span class = "label back-imss border-back-imss">PLAN Y ORDENES MÉDICAS</span></h4>
                                <div class="col-sm-12" id="divNutricion">
                                  <div class="col-sm-3"  id="divRadioNutricion">
