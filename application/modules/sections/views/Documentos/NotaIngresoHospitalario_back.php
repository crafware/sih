        ...
        <div class="col-md-11 col-centered" style="margin-top: 10px ">
            <div class="box-inner">
                        ...
                        <div class="card-body" style="padding: 20px 0px;">
                            <form class="guardar-solicitud-hi-abierto" style="margin-top: 45px" oninput="x.value=parseInt(hf_eva.value)">
                                ...
                                <div class="row">
                                    <div class="col-md-12"> 
                                        <div class="form-group">    
                                            <div class="col-md-2"><h4 class="">Tipo de Interrogatorio</h4></div>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <label class="md-check">
                                                    <input type="radio" name="tipo_interrohgatorio" data-value="<?=$notaingreso[0]['tipo_interrogatorio']?>" class="has-value" value="Estable"><i class="green"></i>Directo
                                                </label>
                                                <label class="md-check">
                                                    <input type="radio" name="tipo_interrohgatorio" data-value="<?=$notaingreso[0]['tipo_interrogatorio']?>" class="has-value" value="Estable"><i class="green"></i>Indirecto
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <h4><span class = "label back-imss border-back-imss">MOTIVO DE ATENCIÓN</span></h4>                      
                                            <textarea class="form-control hf_motivo editor" id="area_editor1" name="hf_motivo" placeholder="Escriba aquí el Motivo de la consulta"><?=$notaingreso[0]['motivo_ingreso']?></textarea>
                                        </div>
                                    </div>
                                </div>
                                        <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <h4><span class = "label back-imss border-back-imss">MÉTODOS AUXILIARES DE DIAGNÓSTICO</span></h4>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                           <h4><span class = "label back-imss border-back-imss">DIAGNÓSTICO DE INGRESO Y COMORBILIDADES</span></h4>
                              <div class="col-md-12">
                                <div class="form-group">
                      ...
                      <!-- estudios modal-->
                        ...
                        <div class="col-sm-12" style="padding: 0;">
                          <div class="form-group">
                              ...
                              <textarea class="form-control" rows="2" name="hf_indicaciones"><?=$hojafrontal[0]['hf_indicaciones']?></textarea>
                          </div>
                        </div>
                        <div class="col-sm-12" style="padding: 0;">
                          <div class="form-group">
             ...
             <?php if($_GET['tipo'] != 'Choque' && $_GET['tipo'] != 'Observación' ){ ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <h4><span class = "label back-imss border-back-imss"><b>TIPO DE URGENCIA </b></span></h4>
