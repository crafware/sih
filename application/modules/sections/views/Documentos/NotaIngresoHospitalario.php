    <form class="guardarNotaIngreso" oninput="x.value=parseInt(escala_eva.value)">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group" id='area_editor_div1'>
                                ...
                                <textarea onchange="deleteTypeLetter('area_editor_div1');" class="form-control motivo_ingreso editor" id="area_editor1" name="motivo_ingreso" placeholder="Escriba aquí el Motivo por el cuál ingresa el paciente al servicio"><?= $notaIngreso[0]['motivo_ingreso'] ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="panel panel-default panel-y">
            <div class="panel-heading">
                <h4>EXAMENES AUXILIARES DE DIAGNÓSTICO</h4>
            </div>
            <div class="panel-body">
                <div class="form-group" id='area_editor_div8'>
                    <h5><span class=""><b>Estudios de Laboratorio</b></span></h5>
                    <textarea onchange="deleteTypeLetter('area_editor_div8');" class="form-control editor" id="area_editor8" rows="2" name="estudios_laboratorio" placeholder="Anote los análisis clínicos de laboratorio"><?= $notaIngreso[0]['estudios_laboratorio'] ?></textarea>
                </div>
                <div class="form-group" id='area_editor_div9'>
                    <h5><span class=""><b>Estudios de Gabinete</b></span></h5>
                    <textarea onchange="deleteTypeLetter('area_editor_div9');" class="form-control editor" id="area_editor9" rows="2" name="estudios_gabinete" placeholder="Rayos X, Imagenología Médica"><?= $notaIngreso[0]['estudios_gabinete'] ?></textarea>
                </div>
            </div>
        </div>
        <!-- Escalas de Salud -->
        <div class="panel panel-default panel-y">
            <div class="panel-heading">
                <h4>ESCALAS Y RIESGOS DE SALUD</h4>
            </div>
            <div class="panel-body">
                <!-- Escla de glasgow -->
                <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-12" style="padding-bottom: 25px; padding-top: 25px">
                ...
                <div class="col-md-3">
                    ...
                    <input type="hidden" id="triage_id" name="triage_id" value="<?= $_GET['folio'] ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="checkbox">
                                    ...
                                    <label style="TEXT-ALIGN:justify"><input type="checkbox" class="suma_rt" name="rt10" value="5">Cirugía de remplazo de cadera o rodilla. <b>(5 ptos)</b></label>
                                </div>
                            </div>
                            <div class="col-md-4">
    ...
    <script type="text/javascript">
        ...
        console.log(document.getElementById("triage_id").value)
