                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                ?>
                                  ...
                                  <i class="fa fa-file-pdf-o icono-accion tip pointer" onclick="AbrirDocumento(base_url+'Inicio/Documentos/GenerarNotaEgreso/<?= $value['notas_id'] ?>?empleado_id=<?= $_GET['empleado_id'] ?>?empleado_roles=<?= $_GET['empleado_roles'] ?>?inputVia=<?= $_GET['tipo'] ?>?via=<?= $value['notas_via'] ?>?tipoNota=<?= $value['notas_tipo'] ?>')" data-original-title="Ver <?= $value['notas_tipo'] ?>"></i>
