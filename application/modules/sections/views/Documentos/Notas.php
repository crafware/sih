          ...
          <div class="panel-body b-b b-light scrollspy-body">
            <div class="card-body" style="padding: 20px 0px;">
              <form class="Form-Notas-COC" oninput="x.value=parseInt(nota_eva.value)">
                ...
                <!-- Panel de Evolución  y/o Actualización del cuadro Clínico -->
                <div class="panel panel-default panel-x">
                  <div class="panel-heading"><h4>ANTECEDENTES</h4></div>
                  <div class="panel-body ">
                    <div class="form-group evolucion-psoap">
                      <label><b><?=$titulo?></b></label>
                      <textarea class="form-control editor" name="nota_problema" rows="3" id="area_editor1" placeholder="Problema o Diagnósticos" <?=$sololectura ?> ><?=$problema?></textarea>
                    </div>
                    <div class="form-group">
                      <label><b id="psoap_subjetivo" >INTERROGATORIO <span style="font-size: 9px">(Subjetivo)</span></b></label>
                      <textarea class="form-control editor" name="nota_interrogatorio" rows="5" id="area_editor2" placeholder="Interrogatorio directo o indirecto"><?=$Nota['nota_interrogatorio']?></textarea>
                    </div>
                    <div class="form-group">
                      <label><b id="psoap_objetivo" >EXPLORACIÓN FÍSICA <span style="font-size: 9px">(Objetivo)</span></b></label>
                      <textarea class="form-control editor" name="nota_exploracionf" rows="5" id="area_editor3" placeholder="Anote sus observaciones"><?=$Nota['nota_exploracionf']?></textarea>
                    </div>
                  </div>
                </div>
                <!-- Panel de Escalas Médicas -->
                <div class="panel panel-default panel-x">
                  <div class="panel-heading"><h4>ESCALAS DE SALUD</h4></div>
                  <div class="panel-body ">
                    <div class="col-md-3">
                ...
                <!-- Panel de Resultados de servicio auxiliares de diagnóstico -->
                <div class="panel panel-default panel-x">
                  <div class="panel-heading"><h4>RESULTADOS DE SERVICIOS AUXILIARES DE DIAGNÓSTICO</h4></div>
                  <div class="panel-body ">
                    <div class="form-group">
                      <h5><span>(Estudios de Laboratorio y Estudios de Gabinete)</span></h5>
                      <textarea class="form-control editor" name="nota_auxiliaresd" rows="5" id="area_editor4" placeholder="Si no cuenta con Resultados dejar en blanco"><?=$Nota['nota_auxiliaresd']?></textarea>
                    </div>
                  </div>
                </div>

                <!-- Panel de Analisi del caso -->
                <div class="panel panel-default panel-x">
                  <div class="panel-heading"><h4>ANÁLISIS DEL CASO (Comentario y Conclusiones)</h4></div>
                  <div class="panel-body ">
                    <div class="form-group evolucion-psoap ">
                      <textarea class="form-control editor" name="nota_analisis" rows="2" id="area_editor5" placeholder="Anote sus comentarios y conclusiones del caso"><?=$Nota['nota_analisis']?></textarea>
                    </div>
                  </div>
                </div>
                <!-- Panel de Actualizacion de diagnosticos -->
                <div class="panel panel-default panel-x">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-2 col-md-4" style="margin-left:40px;">
                ...
                <div class="col-sm-12" id="EstudiosLaboratorio" style="padding:0">
                    <div class="form-group">
                        <label><b>f) Estudios de Laboratorio:</b>
                        </label>
                ...
                <br>
                  ...
                  <div class="col-sm-12">
                      ...
                      <div class="col-sm-12" id="divCuidadosGenerales" style="padding:0">
                        <div class="col-sm-12" style="padding:0">
                          <div class="form-group">
                            <label><b>h) Solicitud de rayos x: &nbsp;  </b></label><input type="checkbox" id="check_estudios">&nbsp;<label id="label_check_estudios">- SI</label>
                  ...
                  <div class="col-sm-12">        
                    <label class="mayus-bold">MÉDICO QUIËN REALIZA LA NOTA</label>      
                  </div>
                  <?php 
                  ...
                  <?php }else { 
                      $medicoTratante= $this->config_mdl->_get_data_condition('os_empleados',array('empleado_id'=> $Nota['notas_medicotratante']));
                      ...
                      <div class="col-sm-12 col-md-12">
                         <div class="form-group">
                            <div class="col-sm-8 col-ms-8">
                              ...
                              <input type="hidden" name="medicoTratante" id="id_empleado"> 
                            </div>
...
<!--<script src="<?= base_url('assets/libs/bootstrap-toggle-master/js/bootstrap-toggle.min.js')?>"></script>-->
<script>
