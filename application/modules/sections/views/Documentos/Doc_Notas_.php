        ...
        <div class="panel-body">
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              ...
              <textarea class="form-control editor" name="nota_auxiliaresd" rows="5" id="area_editor4" placeholder="Resultados de Laboratorio y Gabinete"><?=$Nota['nota_auxiliaresd']?>
              </textarea>
            </div>
          </div>
        </div>
        ...
        <div class="panel-body">
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group evolucion-psoap ">
              <textarea class="form-control editor" name="nota_analisis" rows="5" id="area_editor5" placeholder="Anote sus comentarios y conclusiones del caso"><?=$Nota['nota_analisis']?>
              </textarea>
            </div>
          </div>
        </div>
