        ...
        <div class="box-inner panel-default col-md-10 col-centered" style="margin-top: 40px">
            <div class="panel">
                <div class="panel-heading p teal-900 back-imss">
                    <span style="font-size: 15px;font-weight: 500">GESTIÓN DE CONSULTORIOS</span>
                            ...
                            <table class="table table-bordered table-hover footable  table-no-padding"  data-filter="#filter" data-page-size="6" data-limit-navigation="7">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <i class="fa fa-pencil icono-accion pointer" onclick="AbrirVista(base_url+'Sections/Especialidades/AgregarConsultorios/?es=<?=$_GET['es']?>&cons=<?=$value['consultorio_id']?>&accion=edit',400,300)"></i>&nbsp;
