                                            ...
                                            <div class="tl-wrap b-info ">
                                                ...
                                                <div class="tl-content <?=$background?> panel panel-card w-xl w-auto-xs" style="padding-top: 10px;padding-bottom: 0px;color: white!important">
                                                    ...
                                                    <div class="p b-t b-light" style="padding: 10px 16px 10px 16px;background: #256659">
                                                        ...
                                                        <i class="fa fa-user"></i> <?=$IngresoChoque['empleado_nombre']?> <?=$IngresoChoque['empleado_apellidos']?>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                            ...
                                            <div class="tl-wrap b-info ">
                                                ...
                                                <div class="tl-content <?=$background?> panel panel-card w-xl w-auto-xs" style="padding-top: 10px;padding-bottom: 0px;color: white!important">
                                                    ...
                                                    <div class="p b-t b-light" style="padding: 10px 16px 10px 16px;background: #256659">
                                                        ...
                                                        <i class="fa fa-user"></i> <?=$IngresoChoqueEnf['empleado_nombre']?> <?=$IngresoChoqueEnf['empleado_apellidos']?>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                            ...
                                            <div class="tl-wrap b-info ">
                                                ...
                                                <div class="tl-content <?=$background?> panel panel-card w-xl w-auto-xs" style="padding-top: 10px;padding-bottom: 0px;color: white!important">
                                                    ...
                                                    <div class="p b-t b-light" style="padding: 10px 16px 10px 16px;background: #256659">
                                                        ...
                                                        <i class="fa fa-user"></i> <?=$IngresoChoqueMed['empleado_nombre']?> <?=$IngresoChoqueMed['empleado_apellidos']?>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
