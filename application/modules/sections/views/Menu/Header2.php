...
<html lang="en">
    ...
    <body>
        ...
        <div class="app">
            ...
            <aside id="aside" class="app-aside modal hidde" role="menu">
                <div class="left ">
            ...
            <div id="content" class="app-content" role="main">
                <div class="box">
                    <div class="navbar md-whiteframe-z1 no-radius <?=$Fondo2?>" >
                        <a href="#" data-toggle="sidebar" data-target="#aside" class="navbar-item pull-left visible-lg visible-xs visible-sm">
