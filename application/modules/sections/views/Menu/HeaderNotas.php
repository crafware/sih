...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?=_UM_CLASIFICACION?> | <?=_UM_NOMBRE?></title>
        <meta name="description" content="<?=_UM_CLASIFICACION?> | <?=_UM_CLASIFICACION?>" />
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
        <link href="<?=  base_url()?>assets/libs/jquery/bootstrap/dist/css/bootstrap.css" rel="stylesheet" type="text/css" />
        <link href="<?=  base_url()?>assets/libs/assets/animate.css/animate.css" type="text/css" rel="stylesheet" />
        ...
        <link href="<?=  base_url()?>assets/styles/app.css" type="text/css" rel="stylesheet"/>
