...
            <div class="slides-container" > <img src="<?= base_url()?>asset_landing/images/urgencias_vespertinas.jpg" alt=""> <img src="<?= base_url()?>asset_landing/images/urgencias_vespertinas.jpg" alt=""></div>
    ...
    <section id="indicadores">
        ...
        <div class="container">
            <div class="title">
                <h2>Indicadores TRIAGE ENERO - FEBRERO</h2>
                <div class="col-sm-2">
                </div>
                <div class="col-sm-4 grafica1 hidden">
                    <div id="contenedorGrafica">
                        <canvas id="graficaHombreMujeres">
                        <!-- Grafica por porcentaje hombres <> mujeres-->
                        </canvas>
                    </div>
                </div>
                    ...
                    <div class="row" >
                        <div class="col-md-4"><br>
                            <div class="input-group m-b">
                                <span class="input-group-addon" style="background: #256659 !important;"><i class="fa fa-calendar" style="color: #FDFEFE !important;"></i></span>
                                <input type="text" class="yyyy-mm-dd" name="FECHA_INICIO" style="width: 110px !important; text-align: center !important;">
                            </div>
                        </div>
                        <div class="col-md-4"><br>
                            <div class="input-group m-b"><strong style="margin-right: 9px;">a</strong>
                                <span class="input-group-addon" style="background: #256659 !important;"> <i class="fa fa-calendar" style="color: #FDFEFE !important;"></i></span>
                                <input type="text" class="yyyy-mm-dd" name="FECHA_FIN" style="width: 110px !important; text-align: center !important;">
                            </div>
                        </div>
                        <div class="col-sm-2"><br>
                            <div class="graficar btn btn-primary" style="color: #FDFEFE !important; background: #256659 !important; width: 110px !important; text-align: center !important; border-radius: 2px; margin-left: 14px !important; height: 31px !important;">Graficar</div>
                        </div>
                    </div> 
                    <br><br>
                    <p style="font-size: 18px; font-weight: bold;">PORCENTAJE HOMBRES - MUJERES</p>
                    <p>Tamaño de la Muestra <span class="fechas"></span> (<span id="diastranscurridos"></span> Días). </p>
                    <p>Tiempo Promedio: <strong>11 minutos.</strong></p>
                    <p>Número de Pacientes Hombres : <strong id="datosHombres"></strong></p>
                    <p>Número de Pacientes Mujeres : <strong id="datosMujeres"></strong></p>
                    <br><p>Total :<strong id="total"></strong></p>
        ...
        <div class="container">
            <div class="title">
                <div class="col-sm-2"> </div>
                <div class="col-sm-4 grafica2 hidden">
                    <div id="contenedorGraficaClasificacion">
                        <canvas id="graficaPorClasificacion">
                            <!--Grafica por porcentaje de clasificacion-->
                        </canvas>
                    </div>
                </div>
                <div class="col-md-5 grafica2 hidden">
                    </div> 
                    <br><br>
                    <p style="font-size: 18px; font-weight: bold;">PORCENTAJE POR CLASIFICACIÓN</p>
                    <p>Porcentaje de Pacientes clasificados por colores.</p>
                    <p>Azul:-------------<strong id="AZUL"></strong></p>
                    <p>Verde::----------<strong id="VERDE"></strong></p>
                    <p>Amarillo:--------<strong id="AMARILLO"></strong><p>
                    <p>Naranja:----------<strong id="NARANJA"></strong></p>
                    <p>Rojo:---------------<strong id="ROJO"></strong></p>
                    <br><p>Total : <strong id="total_c"></strong></p>
                </div>
                <div class="col-sm-1"> </div>
            </div>
        </div><br><br><br>
