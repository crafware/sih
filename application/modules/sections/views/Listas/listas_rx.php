...
<html lang="en">
    ...
    <div class="app">
        <div class=" bg-big">
            <div class="box-row" style="width: 90%;margin: auto;margin-top: 10px">
                <div class="box-cell">
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="panel-body b-b b-light">
                                    ...
                                    <div class="row row-load hide">
                                        <div class="col-md-12 last_lista_no">
                                            <table class="table m-b-none rx_last_lista">
                                                <tbody>
                                                    <tr class=""></tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="col-md-8">
                                            <h1 class="text-center table-pacientes-rx-no hide" style="margin-top: calc(15%);margin-bottom: calc(15%)">NO HAY LISTA DE PACIENTES </h1>
                                            <div class="row table-pacientes-rx"></div>
        ...
        <script src="<?=  base_url()?>assets/js/sections/Lista_rx.js?<?= md5(microtime())?>" type="text/javascript"></script> 
