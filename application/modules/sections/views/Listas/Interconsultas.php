...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>UMAE | Especilidades del CMN Siglo XXI</title>
        <meta name="description" content="UMAE | Dr. Bernardo Sepúlveda Gutiérrez" />
                    ...
                    <div class="row" >
                        <div class="col-md-12">
                            <div class="panel panel-default " >
                                ...
                                <input type="hidden" name="Listas" value="Interconsultas">
                                <div class="panel-body b-b b-light" style="padding-top: 0px">
                                    ...
                                    <div class="row row-load hide cols-interconsultas" style="margin-top: 5px;"></div>                          
                                </div>
                            </div>  
                        </div>
                    </div>
