                    ...
                    <div class="card-body" style="padding: 0px">
                        <div class="row">
                            ...
                            <div class="col-md-4" style="padding: 0px">
                                <div class="form-group">
                                    <input type="text" name="inputFechaInicio"  class="form-control" id="fechaProductividad" placeholder="Seleccionar Fecha" autocomplete="off" required="">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="panel panel-default ">
                        <div class="panel-body b-b b-light text-center">
                            <br>
                            <h4 class="TOTAL_PACIENTES_CONSULTORIOS_DOC mayus-bold" >REGISTROS: <span>0 Pacientes</span></h4>
                            <br><br>
